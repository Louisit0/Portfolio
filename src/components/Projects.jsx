...
const Projects = () => {
  return (
    <section id="Projects" className="flex flex-col md:w-1/2 mx-auto">
      ...
      <ul>
        <li className="card lg:card-side bg-base-100 shadow-md mb-5 md:mb-14">
          <figure>
            <img
        ...
        <li className="card lg:card-side bg-base-100 shadow-md">
          <figure>
            <img
      ...
      <button className="mx-auto w-1/2 normal-case btn btn-outline btn-warning mt-20 mb-36">
        Show More
      </button>
    </section>
  );
